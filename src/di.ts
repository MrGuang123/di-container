...
if(require.main === module) {
  ...
  console.log('root Logger === child Logger?', root.resolve(TOKENS.Logger) === child.resolve(TOKENS.Logger))
  console.log('root Logger self-singleton?', root.resolve(TOKENS.Logger) === root.resolve(TOKENS.Logger))
}